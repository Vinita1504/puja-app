...
/// Chadhava offerings list widget for cart page
///
/// Displays a list of available offerings with images,
/// descriptions, prices, and add/remove buttons.
class ChadhavaOfferingsListWidget extends StatelessWidget {
  final List<OfferingItemEntity> offerings;
  final List<OfferingItemEntity> selectedOfferings;
  final Function(OfferingItemEntity)? onAddPressed;
  final Function(OfferingItemEntity)? onRemovePressed;
...
class _OfferingItemWidget extends StatelessWidget {
  final OfferingItemEntity offering;
