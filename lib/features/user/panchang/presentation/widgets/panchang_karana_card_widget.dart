...
/// Panchang karana card widget
///
/// Displays Karana information in a compact, attractive layout.
class PanchangKaranaCardWidget extends StatelessWidget {
  final PanchangEntity panchang;

  const PanchangKaranaCardWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    final karana = panchang.karana;
    final endTime = karana.end.toFormattedTime();
