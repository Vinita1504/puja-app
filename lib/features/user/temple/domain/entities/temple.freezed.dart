...
mixin _$TempleEntity {
  ...
  /// Create a copy of TempleEntity
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $TempleEntityCopyWith<TempleEntity> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TempleEntityCopyWith<$Res> {
  factory $TempleEntityCopyWith(
    TempleEntity value,
    $Res Function(TempleEntity) then,
  ) = _$TempleEntityCopyWithImpl<$Res, TempleEntity>;
  @useResult
  $Res call({
    String id,
    String name,
...
/// @nodoc
class _$TempleEntityCopyWithImpl<$Res, $Val extends TempleEntity>
    implements $TempleEntityCopyWith<$Res> {
  _$TempleEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$TempleEntityImplCopyWith<$Res>
    implements $TempleEntityCopyWith<$Res> {
  factory _$$TempleEntityImplCopyWith(
    _$TempleEntityImpl value,
    $Res Function(_$TempleEntityImpl) then,
  ) = __$$TempleEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$$TempleEntityImplCopyWithImpl<$Res>
    extends _$TempleEntityCopyWithImpl<$Res, _$TempleEntityImpl>
    implements _$$TempleEntityImplCopyWith<$Res> {
  __$$TempleEntityImplCopyWithImpl(
    _$TempleEntityImpl _value,
    $Res Function(_$TempleEntityImpl) _then,
  ) : super(_value, _then);
...
class _$TempleEntityImpl implements _TempleEntity {
  const _$TempleEntityImpl({
    required this.id,
    required this.name,
    required this.city,
    required this.state,
  ...
  @override
  String toString() {
    return 'TempleEntity(id: $id, name: $name, city: $city, state: $state, country: $country, address: $address, overview: $overview, history: $history, significance: $significance, architecture: $architecture, offeringsText: $offeringsText, lat: $lat, lng: $lng, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$TempleEntityImplCopyWith<_$TempleEntityImpl> get copyWith =>
      __$$TempleEntityImplCopyWithImpl<_$TempleEntityImpl>(this, _$identity);
}

abstract class _TempleEntity implements TempleEntity {
  const factory _TempleEntity({
